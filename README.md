...
настроен, отправка тихо пропускается и не мешает основному потоку покупки. Языки писем:
болгарский (по умолчанию), английский и украинский — шаблоны лежат в
`backend/templates/emails/` (`ticket_*.html`, `receipt_*.html`).
