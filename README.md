...
| `CLIENT_FRONTEND_ORIGIN` | Публичный URL клиентского фронтенда (для CORS и ссылок на билеты) | `http://localhost:${FRONTEND_PORT}` |
| `ADMIN_FRONTEND_ORIGIN` | Публичный URL админского фронтенда (для CORS) | — |
